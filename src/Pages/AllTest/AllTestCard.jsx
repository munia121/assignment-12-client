                ...
                <div className="rounded-md shadow-md  dark:bg-gray-50 dark:text-gray-800">
                    ...
                    <div className="p-3">
                        ...
                        <div className="space-y-3">
                            <p className="text-sm">
                                {/* <span className="text-base font-semibold text-sky-600">{data.title}</span> */}
                            </p>
                            <p>{data.details.slice(0, 100)}....</p>
                            <div className="flex justify-between pr-5">
                                <input type="text" placeholder="Add a comment..." className=" py-0.5 dark:bg- border-none rounded text-sm pl-0 dark:text-gray-800" />
                                <Link to={`/details/${_id}`}>
                                    <button className="border px-4 py-2 rounded-xl font-bold border-blue-500">See Details</button>
                                </Link>
                            </div>
                        </div>
                    </div>
